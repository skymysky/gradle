...
public class FileLockCommunicator {
    ...
    private static final String NETWORK_UNREACHABLE_ERROR_MESSAGE = "Network is unreachable";
    private static final String CANNOT_ASSIGN_ERROR_MESSAGE = "Cannot assign requested address";
                ...
                try {
                    ...
                    if (message != null && (
                        message.startsWith(SOCKET_OPERATION_NOT_PERMITTED_ERROR_MESSAGE)
                            || message.startsWith(NETWORK_UNREACHABLE_ERROR_MESSAGE)
                            || message.startsWith(CANNOT_ASSIGN_ERROR_MESSAGE)
                    )) {
